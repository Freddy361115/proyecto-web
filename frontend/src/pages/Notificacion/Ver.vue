<template>
    <div class="content">
    <div class="md-layout">
        <div class="md-layout-item md-medium-size-50 md-xsmall-size-25 md-size-50">
...
<md-card-header data-background-color="green">
          ...
          <div class="md-subhead">
            ...
            <span>Creado por: {{notificacion.supervisor}}</span>
          </div>
        </md-card-header>
        <md-card-media md-size="20" v-if="notificacion.extensionSupervisor === 'jpg' || notificacion.extensionSupervisor ==='png'">
      ...
      <md-card-actions>
        <md-button class="md-primary">Marcar como leida</md-button>
      </md-card-actions>
    </md-card>
</div>
</div>
