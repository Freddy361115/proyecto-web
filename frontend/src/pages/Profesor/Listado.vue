<template>
    <div class="content">
        ...
        <div>
            <md-dialog-confirm :md-active.sync="active" md-title="Confirmar eliminar profesor?"
                md-content="Esta seguro de eliminar el profesor seleccionado?" md-confirm-text="Confirmar"
